...
export default async function Home() {
  ...
  return (
    <main className="no-scrollbar w-screen overflow-hidden">
      <section
        id="section"
      ...
      >
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          ...
          />
          <div className="w-full h-full absolute top-0 right-0 bg-black/30"></div>
      ...
      >
        <div id="container" className=" px-6 w-full h-full">
          <div className="w-full h-fit">
            <h3 className="text-[97vh] leading-none font-bebas tracking-tighter ">
              {/* {SectionImageOverlay.heading} */}
              PRIZZM 
            </h3>
            {/* <div className="absolute top-[45%] aspect-square w-[88vw] sm:w-[30vw] left-0">
              <Image
